package com.cambridge.CaptureMechanisms.Network.mitm;
...
public class BouncyCastleSslEngineSource implements SslEngineSource {
    ...
    private static String TAG = BouncyCastleSslEngineSource.class.getSimpleName();
